...
public class ListaDoble {
    ...
    public static void main(String[] args) {
        ...
        ld.insertToTheEnd("Vivo en Egersund");
        ld.insertToTheEnd("Tengo un deseo de ser programador");
        ld.insertToTheEnd("El nombre de mi mama es Luisa");
        ld.insertToTheEnd("Vive en Meanguera");
        ld.insertToTheEnd("Tengo un deseo de volver a verla");
